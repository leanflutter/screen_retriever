...
namespace
{
    ...
    flutter::EncodableMap MonitorToEncodableMap(HMONITOR monitor)
    {
        ...
        size[flutter::EncodableValue("width")] = flutter::EncodableValue(static_cast<double>(info.rcMonitor.right));
        size[flutter::EncodableValue("height")] = flutter::EncodableValue(static_cast<double>(info.rcMonitor.bottom));

        flutter::EncodableMap display = flutter::EncodableMap();

        display[flutter::EncodableValue("id")] = flutter::EncodableValue(0);
        display[flutter::EncodableValue("name")] = flutter::EncodableValue("");
